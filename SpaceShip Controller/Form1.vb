Public Class Form1
    ...
    Private Sub Button12_Click(sender As Object, e As EventArgs) Handles Button12.Click
        If Engine = 0 Then
            Engine = 1
            My.Computer.Audio.Play("C:\Program Files\SpaceShip Controller\Resources\Sounds\enginestart.wav", AudioPlayMode.Background)
            MsgBox("Engine starting.")
        Else
            Engine = 0
            My.Computer.Audio.Play("C:\Program Files\SpaceShip Controller\Resources\Sounds\enginestop.wav", AudioPlayMode.Background)
